          ...
          <tbody>
            {rows.map((r, i) => (
              <tr key={`${r.season}-${r.team}-${i}`} className="border-t border-zinc-800/60 hover:bg-zinc-900/50">
                ...
                <td className="px-3 py-1.5 text-right font-semibold text-accent">{r.pts}</td>
            ...
            {career && (
              <tr className="border-t-2 border-zinc-700 bg-zinc-900 font-semibold">
                ...
                <td className="px-3 py-2 text-right text-accent">{career.pts}</td>
          ...
          {(["regular", "playoffs"] as const).map((t) => (
            <button
              ...
              className={`rounded-full px-4 py-1 capitalize transition ${
                tab === t ? "bg-accent font-semibold text-zinc-950" : "border border-zinc-700 text-zinc-400 hover:border-accent"
              }`}
            >
